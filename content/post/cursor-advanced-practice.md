# Cursor 进阶实战：核心高级能力全解 + 配套标准化AI开发范式体系
...
### 3. Hook 生命周期钩子：拦截、观察、自定义约束 Agent 行为
...
graph TD
    ...
    B --> C[配置 Hook 生命周期]
    C --> D{选择开发范式}
    D -->|小型项目| E[引入 Superpowers]
    D -->|中大型项目| F[安装 OpenSpec]
    D -->|需求复杂| G[安装 mattpocock/skills]
